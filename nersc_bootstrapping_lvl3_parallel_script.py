...
from bootstrapping import (
    ...
    bootstrap_gvdata_parallel   # <--- only change
)
...
def main(hadron):
    ...
    for ensemble in ENSEMBLES:
        ...
        # 4. Perform bootstrap fits (parallel)
        energies = bootstrap_gvdata_parallel(
            gvdata,
            T_original,
            hadron,
            idx,
        ...
        print('bootstrap means: ', np.mean([e.mean for e in energies[1:]]))
